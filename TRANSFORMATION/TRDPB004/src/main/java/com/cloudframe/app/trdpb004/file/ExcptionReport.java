...
@Component("trdpb004_excptionReport")
public class ExcptionReport extends CFFile {

	private Logger logger = LoggerFactory.getLogger(ExcptionReport.class);
	
	@Value("${TRDPB004.ExcptionReport:EXCPTION}")
    ...
    **/
	@Value("${TRDPB004.ExcptionReportCharSet:cp1047}")
	private String charSet;
	
	@Value("${TRDPB004.ExcptionReportCRLFflag:no}")
	private String crlfFlag;

	public String getExcptionReportCharSet() {
		return charSet;
	}
	
	public String getExcptionReportCrlfFlag() {
		return crlfFlag;
	}

	public ExcptionReport()
	{
		setFixedBlockFile(true);	
		setRecord(new byte[1100]);
	...
	public void write(int len) {
		try {
			...
			logger.error("Error during ExcptionReport Write: {}",e.getMessage() ); 		}
	}
